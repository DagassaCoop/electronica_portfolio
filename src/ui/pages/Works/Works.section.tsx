  ...
  return (
    ...
    >
      <h1 className="h1 mb-16">
        Creative works I’ve filmed, designed, and captured
      </h1>

      <div className="w-fit gap-2 sm:gap-4 md:gap-8 flex justify-center items-center mb-8 border border-color-grey/50 border-dashed rounded-xl p-2">
